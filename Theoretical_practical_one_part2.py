...
data3 = four_atom_linear[0] + four_atom_linear[1]+four_atom_linear[2] + four_atom_cyclic[1] + four_atom_cyclic[2]

data3 = np.reshape(data2,(5,8)).T

outside = ['','Tetrahedral Energies','Tetrahedral Energies','Rhomboidal Energies','Rhomboidal Energies']
inside = ['Electrons','Normal','Adjusted','Normal','Adjusted']
hier_index = list(zip(outside,inside))
hier_index = pd.MultiIndex.from_tuples(hier_index)
